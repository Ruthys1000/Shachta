...
- אם אתה משווה את הכלל לעברית, ההשוואה חייבת להיות נכונה עובדתית. שים לב: סדר תואר-אחרי-שם-עצם זהה בערבית ובעברית (גם בעברית אומרים "בית חדש" ולא "חדש בית") - אסור לתאר זאת כ"הפך מעברית". אם אינך בטוח שהשוואה לעברית נכונה, הסבר את הכלל בלי להשוות לעברית בכלל, ולא תמציא ניגוד שאינו קיים.
